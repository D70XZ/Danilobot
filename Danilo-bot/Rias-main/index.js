...
const BotName = 'Danizinn'; 
const aktif = '08:00 - 22:00';
const vcard = 'BEGIN:VCARD\n'
            + 'VERSION:3.0\n' 
            + 'FN:D70\n' // pumalby gremory
            + 'ORG:Lexa;\n' // Danilin
            + 'TEL;type=CELL;type=VOICE;waid=:+55 11994194624\n' //Nomor whatsapp kamu
            + 'END:VCARD'
prefix = '.','!','#'
blocked = []
limitawal = '999999999'
		...
		try {
			...
			mess = {
				...
				only: {
					...
					mod: '[❗] ESTE PEDIDO É ESPECÍFICO PARA USUARIO MOD pumalby BOT*',
					benned: 'Você para a banda, por favor, contate o proprietário para abrir sua banda',
					ownerG: '[❗] D70_maia? Este é um recurso especial para o D70_maia ❌',
					ownerB: '[❗] D70_maia? Este é um recurso especial para o D70_maia ❌',
					userB: `──「 LISTA 」──\nOlá Kak !\nDesculpe, irmã. Você não está registrado como amigo de rias. Registre-se para fazer amizade com o bot D70Lin por meio, \n\nCommand : ${prefix}daftar nama|idade\nExemplo : ${prefix}daftar D70Lin|17\n\n──「 D70Linzin 」──`,
					admin: '[❗] so adm irmão! ❌',
			...
			const ownerNumber = ["5511994194624@s.whatsapp.net"] // replace this with your number
			const mod = [ownerNumber,"5511994194624@s.whatsapp.net"]//ubah nomor lo
			const adminbotnumber = ["5511994194624@s.whatsapp.net"]//ubah nomor lo
			const frendsowner = ["5511994194624@s.whatsapp.net"]//ubah nomor lo
			const premium = ["5511994194624@s.whatsapp.net","+5511964578978@s.whatsapp.net","5511961328953@s.whatsapp.net"] 
          ...
          case 'snack':
               ...
               if (anu.error) return reply(anu.error)
				...
				case 'loli2':
					...
					anu = await fetchJson(`https://api.vhtear.com/(terest?query=loli&apikey={BELI APIKEY BIAR WORK DI 0816546638}`, {method: 'get'})
...
break
				...
				case 'hinata':
					...
					reply(mess.wait)
					anu = await fetchJson(`https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQPk5TAnIG0p4RbD3wrinpDnUWmyUsrrLRM-Q&usqp=CAU`, {method: 'get'})
...
// recursos anime, random @D70
          ...
          reply('Espere..')
				...
				case 'walpaperanime':
					...
					break
					case 'dado':    
					if (!isPremium) return reply('Você não é um Membro Premium, entre em contato com o D70 ou digite *.Daftarvip* para adquirir o acesso Premium!' ,text, { quoted: mek })
				...
				case 'neko':
					...
					client.sendMessage(from, tod, image, { quoted: mek, caption: '*╭────*「 *D70LIN✨* 」\n*│+ wa.me/5511961328953*╰──────*「 *D70LIN* 」*────*\n\n*_SE QUER SER ADMIN DO BOT Akeno_*\n*_Tipo /iklan_*' })
					break
				case 'iklan':
				...
				if (!isUser) return reply(mess.only.userB)
					...
					client.sendMessage(from, sa, image, { quoted: mek, caption: '*╭────*「 *PREMIUM USER👑* 」\n*│+ wa.me/55973747709/*╰──────*「 *D70Lin * 」*────*\n\n*_SE QUER SER UM USUÁRIO PREMIUM DO  akeno_*\n*_Ketik #daftarvip*' })
					break
					case 'cekmod': 
           ...
           case 'shitlist':
               ...
               break
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* DaniloD70\n\n*WPP:* wa.me/+5511994194624
					break
				case 'setprefix':
					if (args.length < 1) return
					if (!isOwner) return reply(mess.only.ownerB)
...
//CASE BY @D70Linzinn 愛

case 'gerarnick': //@D70Linzinn 愛
teks = body.slice(10)
...
break
case 'narutobanner': //@D70Linzinn 愛
teks = body.slice(13)
...
//COMANDOS NSFW CASE'S BY @D70Linzinn 
case 'lolizinhas': // @D70Linzinn 愛
reply('Enviando...')
buffer = await getBuffer(`https://hadi-api.herokuapp.com/api/neko`)
client.sendMessage(from, buffer, image, {quoted: mek})
break
case 'hentai': //@D70Linzinn 愛
reply('Enviando....')
buffer = await getBuffer(`https://hadi-api.herokuapp.com/api/neko2`)
client.sendMessage(from, buffer, image, {quoted: mek})
break
case 'waifu': //@D70Linzinn 
buffer = await getBuffer(`https://hadi-api.herokuapp.com/api/neko2`)
client.sendMessage(from, buffer, image, {quoted: mek})
break

//COMANDOS PLAY BY @D70Linzinn 
case 'play':   
//@D70Linzinn 
				reply(mess.wait)
